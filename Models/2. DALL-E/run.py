...
from diffusers import DalleMiniPipeline, UNet2DConditionModel
from transformers import CLIPTokenizer
from peft import LoraConfig, get_peft_model, save_pretrained_peft_model
import torch

# Configurations
model_name = "dalle-mini/dalle-mini"  # Replace with your DALL-E model name
dataset_path = "./custom_dataset"  # Path to your dataset
output_dir = "./dalle-lora-finetuned"  # Directory to save LoRA weights
batch_size = 4
num_epochs = 5
learning_rate = 1e-4
...
# 2. Load DALL-E Model and Tokenizer
pipeline = DalleMiniPipeline.from_pretrained(model_name, torch_dtype=torch.float16)
pipeline.to("cuda")
